...
public class Config
{
	...
	public static void load()
	{
		...
		Property itemConfig = config.get(Configuration.CATEGORY_GENERAL, "Drops", defaultItems);
		...
		Property listID = config.get(Configuration.CATEGORY_GENERAL, "Biomes", defaultBiomes);
		listID.comment = "These are the biome IDs representing biomes in which tumbleweed will spawn, they still spawn only on deadbushes.\n Defaults are: Desert, Desert Hill, Desert M (whatever that is).";
